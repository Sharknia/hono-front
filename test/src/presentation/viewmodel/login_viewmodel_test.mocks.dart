...
// in hotdeal_with_hono/test/src/presentation/viewmodel/login_viewmodel_test.dart.
...
class MockLoginUseCase extends _i1.Mock implements _i3.LoginUseCase {
  ...
  @override
  _i4.Future<_i2.Token> call(String? email, String? password) =>
      (super.noSuchMethod(
            Invocation.method(#call, [email, password]),
            returnValue: _i4.Future<_i2.Token>.value(
              _FakeToken_0(this, Invocation.method(#call, [email, password])),
            ),
          )
